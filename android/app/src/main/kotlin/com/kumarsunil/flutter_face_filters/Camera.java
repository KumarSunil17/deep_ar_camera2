...
import com.kumarsunil.flutter_face_filters.media.MediaRecorderBuilder;
import com.kumarsunil.flutter_face_filters.types.ExposureMode;
import com.kumarsunil.flutter_face_filters.types.FlashMode;
import com.kumarsunil.flutter_face_filters.types.FocusMode;
import com.kumarsunil.flutter_face_filters.types.ResolutionPreset;
...
public class Camera implements AREventListener {
  ...
  private void initializeDeepAR() {
    ...
    deepAR.setRenderSurface(flutterSurface, previewSize.getWidth(), previewSize.getHeight());
  }
          ...
          switch (pictureCaptureRequest.getState()) {
            ...
            case preCapture:
              ...
              if (aeState == null
                ...
                pictureCaptureRequest.setState(PictureCaptureRequest.State.waitingPreCaptureReady);
              }
              break;
...
//            buffers[currentBuffer].position(0);
            if (deepAR != null) {
              deepAR.receiveFrame(buffer, img.getWidth(),img.getHeight(), sensorOrientation, isFrontFacing);
            }
...
//
  ...
  public void loadMask() {
    ...
    deepAR.switchEffect("filter", "file:///android_asset/sepia");
  }
}
